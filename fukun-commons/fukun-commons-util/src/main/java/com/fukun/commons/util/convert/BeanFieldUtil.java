...
import com.fukun.commons.util.annotations.Convert;
import com.fukun.commons.util.annotations.FullToHalf;
import com.fukun.commons.util.annotations.Trim;
...
/**
 * Bean 字段值转化工具（支持添加{@link FullToHalf} {@link Trim}  等注解）
 *
 * @author tangyifei
 * @since 2019-5-22 16:54:06 PM
 */
@Slf4j
